...
void startProduction(){
  ...
  sem_destroy(&task->sem0);
  sem_destroy(&task->sem1);
  sem_destroy(&task->sem2);
  sem_destroy(&task->sem3);
  sem_destroy(&task->sem4);
  sem_destroy(&task->sem5);
  sem_destroy(&task->sem6);
  sem_destroy(&task->semA);
  sem_destroy(&task->semB);
  sem_destroy(&task->semC);
  sem_destroy(&task->sem_body);
  free(task); 
  free(robotsA);
  free(robotsB);
  free(robotsC);
